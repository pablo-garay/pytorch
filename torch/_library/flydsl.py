...
def flydsl_op(
    ...
    *,
    ...
    Example::
        ...
        wrapped_launcher = torch.library.wrap_flydsl(
            launcher, mutates_args={"out"}
        )
...
def wrap_flydsl(
    ...
    *,
    ...
    from flydsl.expr.typing import Constexpr, Tensor as FlyDSLTensor
    ...
    signature = resolve_signature(jit_launcher.func)
    ...
    if mutations is not None:
        ...
        compile_time_parameters = {
            ...
            and (
                Constexpr.is_constexpr_annotation(parameter.annotation)
                or is_type_param_annotation(parameter.annotation)
            )
        }
